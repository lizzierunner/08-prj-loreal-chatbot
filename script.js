...
async function sendToAPI(userMessage) {
  try {
    ...
    // ⚠️ IMPORTANT: Replace with your actual Cloudflare Worker URL
    // After deploying your Worker, paste the URL here (e.g., https://loreal-chatbot-api.yourusername.workers.dev)
